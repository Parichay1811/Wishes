export const PHOTOS = [
  {
    id: 1,
    imageUrl: '/TGP_9139.jpg', 
    caption: 'The Beginning',
    memory: 'Where it all started - your beautiful wedding day'
  },
  {
    id: 2,
    imageUrl: '/first.jpg',
    caption: 'First Year',
    memory: 'Learning, growing, and loving together'
  },
  {
    id: 3,
    imageUrl: '/travel.jpg',
    caption: 'Adventures Together',
    memory: 'Creating memories around the world'
  },
  {
    id: 4,
    imageUrl: '/3.webp',
    caption: 'Year Three',
    memory: 'Ups and downs, arguments and apologies — and a love that always found its way back'
  },
  {
    id: 5,
    imageUrl: '/4th.jpg',
    caption: 'Four Years Strong',
    memory: 'Building your dreams side by side'
  },
  {
    id: 6,
    imageUrl: '/3.png',
    caption: 'Four years done',
    memory: 'Four years of laughter, disagreements, and a love that never gave up.'
  },
  {
    id: 7,
    imageUrl: '/baby.png',
...
// Memory milestones data
export const MILESTONES = [
  { 
    year: 'Year 1', 
    title: 'New Beginnings', 
    description: 'Starting your journey together as one' 
  },
  { 
    year: 'Year 2', 
    title: 'Growing Stronger', 
    description: 'Building foundations of love and trust' 
  },
  { 
    year: 'Year 3', 
    title: 'Dreams Realized', 
    description: 'Making dreams come true together' 
  },
  { 
    year: 'Year 4', 
    title: 'Forever Love', 
    description: 'Celebrating four amazing years' 
  }
];

// Brother's message content
